...
private enum OnboardingStep: Int, CaseIterable, Identifiable {
    ...
    var subtitle: String {
        ...
        case .microphone:
            return "Comet needs live audio input before it can capture speech."
        case .accessibility:
...
struct OnboardingWindow: View {
    ...
    private var welcomeStep: some View {
        VStack(alignment: .leading, spacing: 16) {
            Text("Comet keeps capture, cleanup, and paste in one pass. This short setup makes sure the menu bar app is ready before your first dictation.")
                .font(.subheadline)
                .foregroundStyle(.secondary)
        ...
        VStack(spacing: 10) {
            SetupChecklistRow(
                ...
                detail: appState.microphoneAccessGranted
                    ? "Comet can capture speech from your active input device."
                    : "Allow microphone access so Comet can record your voice.",
            ...
            Text("If the system prompt was dismissed earlier, use Open Settings and enable Comet manually in Privacy & Security > Microphone.")
                .font(.caption)
                .foregroundStyle(.secondary)
        }
    }
        ...
        VStack(spacing: 10) {
            SetupChecklistRow(
                ...
                detail: appState.hotkeyManager.isAccessibilityGranted
                    ...
                    : "Comet needs accessibility access for global shortcuts and text insertion.",
        ...
        VStack(spacing: 10) {
            SetupChecklistRow(
                ...
                detail: appState.hasRequiredPermissions
                    ...
                    : "You can finish setup later, but Comet won’t be seamless until both permissions are granted.",
